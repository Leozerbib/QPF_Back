package com.example.ControlerWebapp.controler;

import com.example.Entities.DTO.Team.*;
import com.example.Entities.DTO.Team.CreateTeamDto;
import com.example.Entities.DTO.User.UserDTO;
...
import com.example.Entities.model.user.*;
import com.example.Entities.service.implementation.TeamServiceImpl;
import com.example.Entities.service.implementation.UserServiceImpl;
import com.example.Entities.service.implementation.UserteamServiceImpl;
...
public class Team_controler {
    ...
    private Team mapTeamDTOToTeam(TeamDto teamDTO){
        ModelMapper mapper = new ModelMapper();
        Team team = new Team(1L,teamDTO.getName(), teamDTO.getNbr_user(), teamDTO.getDate_crea(),null,teamDTO.getUserTeam(),null);
        return team;
    }
    ...
    private Team mapRestrictedTeamDTOToTeam(RestrictedTeamDto teamDTO){
        ModelMapper mapper = new ModelMapper();
        Team team = new Team(1L,teamDTO.getName(), 0,null,null,null,null);
        return team;
    }
